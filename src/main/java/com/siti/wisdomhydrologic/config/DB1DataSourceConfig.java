...
@MapperScan(basePackages = "com.siti.wisdomhydrologic.datepull.*.*", sqlSessionFactoryRef = "DB1Factory")
public class DB1DataSourceConfig {
    ...
    public SqlSessionFactory DB1Factory(@Qualifier("DB1dataSource") DataSource dataSource) throws Exception {
        ...
        bean.setTypeAliasesPackage("com.siti.wisdomhydrologic.datepull.*.*");
